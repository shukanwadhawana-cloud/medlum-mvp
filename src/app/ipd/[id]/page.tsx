 ...
 return <AppShell><div className="p-3 max-w-[1400px] mx-auto">
  ...
  <div className="bg-white rounded-b-xl border shadow-sm flex min-h-[520px]">
   ...
   <div className="flex-1 p-4 overflow-auto text-xs">
    ...
    {/* COVER SHEET NOTES */}
    {mainTab==="Discharge Summary"&&leftNav==="Final Discharge Summary"&&(
     <form onSubmit={saveDischargeStructured} className="space-y-3 max-w-3xl">
      <div className="flex flex-wrap items-center justify-between gap-2">
       <div><h3 className="font-semibold text-sm">Discharge Summary</h3><p className="text-[10px] text-gray-500">Complete the final clinical discharge summary here. Administrative clearance runs in parallel.</p></div>
       <Link href={`/ipd-summaries/${selected.id}/print`} target="_blank" className="h-9 px-3 rounded-lg border text-xs inline-flex items-center">Print / Save PDF</Link>
      </div>
