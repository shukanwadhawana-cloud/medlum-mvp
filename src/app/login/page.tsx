  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex w-[42%] bg-gradient-to-b from-[#8B1538] to-[#140a1f] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <p className="relative z-10 text-white/80 text-lg max-w-sm">
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="mt-10 space-y-5">
            ...
            <div>
              ...
              <input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} className="w-full h-12 px-4 rounded-xl border border-gray-200" placeholder="doctor@clinic.com" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1.5">Password</label>
              <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} className="w-full h-12 px-4 rounded-xl border border-gray-200" placeholder="••••••••" />
            </div>
