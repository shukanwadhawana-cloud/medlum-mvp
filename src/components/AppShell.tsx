        ...
        <div className="mx-auto max-w-7xl px-3 sm:px-4 lg:px-6">
          <div className="flex items-center gap-2 py-2.5">
            ...
            <div className="ml-auto flex shrink-0 items-center gap-1.5">
              ...
              <button type="button" onClick={() => setMoreOpen(true)} className={`hidden sm:inline-flex min-h-9 min-w-[3.25rem] items-center justify-center gap-1 rounded-md px-2.5 py-1.5 text-xs font-medium ${moreActive ? "bg-[#c2183a] text-white" : "bg-white/15 text-white hover:bg-white/25"}`} title="Open menu"><Icon name="more" size={14} /><span>Menu</span></button>
