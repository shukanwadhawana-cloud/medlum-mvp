...
const products: Product[] = [
  ...
  { name: "Tuition", description: "Tuition classes, students, fees and attendance", status: "Planned", detail: "Future MedLum product" },
  { name: "Spa", description: "Appointments, clients, services and revenue", status: "Planned", detail: "Future MedLum product" },
  { name: "Garage", description: "Vehicles, jobs, parts, customers and billing", status: "Planned", detail: "Future MedLum product" },
];
