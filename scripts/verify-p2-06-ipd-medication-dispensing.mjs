...
assert(ipdPage.includes("Pharmacy status"),"IPD UI must display pharmacy status");
assert(ipdPage.includes("does not represent medication administration"),"IPD UI must distinguish dispensing from administration");
